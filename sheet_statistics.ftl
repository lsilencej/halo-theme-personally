...
<body class="bg-[#f9f9f9] moon-main dark:bg-neutral-800">
            ...
            <div class="page-content w-full block overflow-hidden">
                <div class="page-item hover:shadow-lg duration-300 mb-12">
                    <div class="page-content bg-white p-4 lg:p-8 text-767676 flex flex-col space-y-3 dark:bg-neutral-900">
                        ...
                        <div id="post-calendar" style="width: auto; height: 250px"></div>
                        <hr>
                        <div id="category-echarts" style="width: auto; height: 400px"></div>
                        <hr>
                        <div id="site-trend" style="width: auto; height: 400px"></div>
                        <hr>
                        <div id="site-area" style="width: auto; height: 400px"></div>
                        <hr>
                        <div id="site-source" style="width: auto; height: 700px"></div>
                        <hr>
                    </div>
                </div>
                <div id="comment">
